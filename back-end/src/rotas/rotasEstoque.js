...
router.get('/dashboard/resumo',validarAutenticacao,todos,c.resumo);
...
router.post('/ajuste-manual',validarAutenticacao,autorizarPerfil('GERENTE'),c.registrarAjusteManual);
