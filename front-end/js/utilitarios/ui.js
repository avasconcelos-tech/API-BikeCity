...
export function configurarModal(modal, fechar) {
    ...
    modal.querySelectorAll('.btn-close').forEach((botao) => botao.setAttribute('aria-label', 'Fechar'));
    const obterFocos = () => [...modal.querySelectorAll('button, input, select, textarea, a, [tabindex]:not([tabindex="-1"])')]
